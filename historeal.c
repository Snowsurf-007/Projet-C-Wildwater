...
AVL* creationRealAVL(float e, char* c);
AVL* rotationGauche(AVL* a);
AVL* rotationDroite(AVL* a);
AVL* doubleRotationGauche(AVL* a);
AVL* doubleRotationDroite(AVL* a);
AVL* equilibrage(AVL* a);
AVL* insertRealAVL(AVL* a, char* e, int* h, float nb);
void traiter(AVL* a);
void infixe(AVL* a);
void prefixe(AVL* a);
void suffixe(AVL* a);
...
/* =====================
   INSERTION AVL
   ===================== */
AVL* insertRealAVL(AVL* a, char* e,int* h,float capter) {
    if (a == NULL) {
    	*h=1;
        return creationRealAVL(capter, e);
    }
    ...
    if (z == 0) {
        ...
        a->fg = insertRealAVL(a->fg, e, h, capter);
        *h=-*h;
    }
    else if(z < 0){
        a->fd = insertRealAVL(a->fd, e, h, capter);
    }
    else{
        *h=0;
        return a;
